...
static G_TIM: Mutex<RefCell<Option<CounterUs<TIM3>>>> = Mutex::new(RefCell::new(None));
...
fn TIM3() {
    ...
    static mut TIM: Option<CounterUs<TIM3>> = None;
...
fn main() -> ! {
    ...
    let mut timer = dp.TIM3.counter(&clocks);
